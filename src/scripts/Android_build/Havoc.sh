...
# To run 
# curl -SsL https://raw.githubusercontent.com/HritwikSinghal/My_guides/new/src/scripts/Android_build/Havoc.sh | sudo bash
...
git clone "https://www.github.com/HritwikSinghal/android_device_realme_X2.git" -b havoc device/realme/X2
